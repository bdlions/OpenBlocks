 ...
 */
	...
	public void workspaceEventOccurred(WorkspaceEvent e) {
		...
		// DISCONNECTING
			...
			revertPoly(Block.getBlock(link.getSocketBlockID()), link.getSocket());
		}
 ...
 */ 
	 ...
	 */
	private static void connectPoly(Long setterBlockID, BlockConnector setterConn) {
	 ...
	 * @param setterConn is the SETTER CONN
     */
    private static void setPolyConnectors(BlockConnector setterConn, Long setterBlockID) {
    	Block otherBlock = Block.getBlock(setterConn.getBlockID());
 ...
 */
	 ...
	 * @param setterConn is the SETTER CONN
     */
    private static void revertPolyConnectors(BlockConnector setterConn, Long setterBlockID) {
		Block otherBlock = Block.getBlock(setterConn.getBlockID());
